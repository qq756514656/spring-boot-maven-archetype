package ${package}.redis.service.impl;

import ${package}.exception.DeniedException;
import ${package}.exception.RedisConnectException;
import ${package}.function.JedisExecutor;
import ${package}.redis.service.RedisService;
import ${package}.support.RedisInfo;
import ${package}.util.Constants;
import ${package}.util.WebUtils;
...
public class RedisServiceImpl implements RedisService {
    ...
    public void clearUser() throws Exception {
        ...
        String header = request.getHeader(Constants.AUTHORIZATION_TOKEN);
        if (StringUtils.isBlank(header)) {
            throw new DeniedException(HttpStatus.UNAUTHORIZED.value(), "authorization is blank 无认证信息");
        }
        del(header);
    }
